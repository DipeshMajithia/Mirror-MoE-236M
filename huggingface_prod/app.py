...
# --- Configuration ---
MODELS_CONFIG = {
    "Hybrid (Chat + Facts)": "mirror_ai_hybrid.safetensors",
    "Elite (Logic + IQ)": "mirror_ai_elite.safetensors",
    "Master (All-Rounder)": "mirror_ai_master.safetensors"
}
TOKENIZER_PATH = "custom_bpe_32k.json"
REPO_ID = "dipeshmajithia/Mirror-80M-MoE"
